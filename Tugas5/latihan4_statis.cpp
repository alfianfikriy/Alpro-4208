...
int main() {
    ...
    mahasiswa[0].nim = "A11.2020.12345";
    mahasiswa[0].nama = "Ari";
    mahasiswa[0].jurusan = "Brodcasting";
    mahasiswa[0].tahunLulus = 2023;

    mahasiswa[1].nim = "A11.2020.11111";
    mahasiswa[1].nama = "Bambang";
    mahasiswa[1].jurusan = "Sistem Informasi";
    mahasiswa[1].tahunLulus = 2013;

    mahasiswa[2].nim = "A11.2020.22222";
    mahasiswa[2].nama = "Andro";
    mahasiswa[2].jurusan = "DVK";
    mahasiswa[2].tahunLulus = 2003;

    mahasiswa[3].nim = "A11.2020.33333";
    mahasiswa[3].nama = "Sholeh";
